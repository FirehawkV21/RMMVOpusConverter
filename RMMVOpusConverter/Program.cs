...
internal static class Program
{
    ...
    private static readonly StringBuilder _stringBuffer = new();
            ...
            if (_isParallel)
            {
                Parallel.ForEach(fileMap, soundFile =>
                {
                    ...
                    Console.WriteLine("[{0}]Thread No.{1} is converting {2} to Opus...", DateTime.Now,
                        Environment.CurrentManagedThreadId, soundFile);
                    ...
                    if (converterProcess.ExitCode != 0)
                        Console.WriteLine(
                            ...
                            DateTime.Now, Environment.CurrentManagedThreadId, soundFile, converterProcess.ExitCode);
